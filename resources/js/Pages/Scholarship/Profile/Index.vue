                ...
                <div class="col-md-12">
                    ...
                    <blockquote class="p-3 border-light border rounded ">
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                <p class="mb-2 text-primary fw-bold">{{ scholar.data.profile.lastname}}, {{ scholar.data.profile.firstname}} {{ scholar.data.profile.middlename }} </p>
                            </div>
                        </div>
                    ...
                    <div class="row font-size-12">
                        <div class="col-md-6" v-if="scholar.data.education">
                            <blockquote class="p-3 border-light border rounded ">
                                ...
                                <div class="row font-size-12 mt-3">
                                    <div class="col-sm-12">
                                        ...
                                        <p class="fw-bold text-dark mb-0">{{scholar.data.education.school.name}} - <span class="text-muted">{{scholar.data.education.school.campus}}</span></p>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <h6 class="text-muted font-size-11 mb-0"><i class="bx bxs-graduation me-1 text-primary"></i>Course</h6>
                                        <p class="fw-bold text-dark mb-0">{{scholar.data.education.course.name}}</p>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <h6 class="text-muted font-size-11 mb-0"><i class="bx bxs-calendar me-1 text-primary"></i>Year level</h6>
                                        <p class="fw-bold text-dark mb-0">{{scholar.data.education.level.name}} Year</p>
                                    </div>
                                </div>
                            </blockquote>
                        </div>
                        <div class="col-md-6" v-if="scholar.data.address">
                            <blockquote class="p-3 border-light border rounded ">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        ...
                                        <p class="fw-bold text-dark mb-0">{{scholar.data.address.region.region}} ({{ scholar.data.address.region.name }})</p>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <h6 class="text-muted font-size-11 mb-0"><i class="bx bx-map-alt me-1 text-primary font-size-15"></i>Province</h6>
                                        <p class="fw-bold text-dark mb-0">{{ scholar.data.address.province.name }}</p>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <h6 class="text-muted font-size-11 mb-0"><i class="bx bx-sitemap me-1 text-primary"></i>Municipality</h6>
                                        <p class="fw-bold text-dark mb-0"> {{ scholar.data.address.municipality.name }}</p>
                                    </div>
                                </div>
                            </blockquote>
                        </div>
