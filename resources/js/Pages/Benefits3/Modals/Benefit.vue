                ...
                <div class="col-md-12 p-3 mb-n4">
                    <blockquote class="p-3 border-light border rounded">
                        <div class="d-flex mb-n2">
                            <div class="me-1"><i class="bx bxs-quote-alt-left text-primary font-size-14"></i></div>
                            <div>
                    ...
                    <div role="group" class="form-row form-group mb-1" v-for="benefit in user.benefits" v-bind:key="benefit.id">
                        <label for="text" class="col-lg-8 col-form-label">{{ benefit.benefit.name }} <span v-if="benefit.benefit.id == 1">({{ benefit.month}})</span></label>
                        <div class="col">
